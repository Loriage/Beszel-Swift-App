...
private func aDummyFunctionToSilenceWarnings() {
    let _ = NSLocalizedString("timeRange.lastHour", comment: "")
    let _ = NSLocalizedString("timeRange.last12Hours", comment: "")
    let _ = NSLocalizedString("timeRange.last24Hours", comment: "")
    let _ = NSLocalizedString("timeRange.last7Days", comment: "")
    let _ = NSLocalizedString("timeRange.last30Days", comment: "")
